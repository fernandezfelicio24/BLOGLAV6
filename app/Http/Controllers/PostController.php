...
class PostController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $post = Posts::create([
            ...
            'gambar'   => 'publicu/uploads/posts/'.$new_gambar,
            'slug'     => Str::slug($request->judul),
            'users_id'  => Auth::id()
        ]);

        $post->tags()->attach($request->tags);
        $gambar->move('publicu/uploads/posts/',$new_gambar);
    ...
    public function destroy($id)
    {
        $post = Posts::findorfail($id);
        $post->delete();
        return redirect()->back()->with('success','Data berhasil Dihapus (Silahkan check di trashed post)');
    }
    ...
    public function restore($id){
        ...
        $post->restore();
        return redirect()->back()->with('success','Data berhasil Direstore (Silahkan check di list post)');
    }
