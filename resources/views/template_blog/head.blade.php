...
<title>Callie HTML Template</title>
	...
	<!-- Bootstrap -->
<link type="text/css" rel="stylesheet" href="{{asset('frontendtemp/css/bootstrap.min.css')}}" />

	<!-- Font Awesome Icon -->
	<link rel="stylesheet" href="{{asset('frontendtemp/css/font-awesome.min.css')}}">

	<!-- Custom stlylesheet -->
	<link type="text/css" rel="stylesheet" href="{{asset('frontendtemp/css/style.css')}}" />
		...
		<div id="nav">
			...
			<div id="nav-top">
				<div class="container">
					...
					<!-- logo -->
					<div class="nav-logo">
						<a href="index.html" class="logo"><img src="{{asset('frontendtemp/img/logo.png')}}" alt=""></a>
					</div>
					<!-- /logo -->
							...
							<div class="dropdown">
								<div class="dropdown-body">
									<ul class="dropdown-list">
										@foreach ($category_widget as $hasil1)
										<li><a href="category.html">{{$hasil1->nama}}</a></li>
										@endforeach
